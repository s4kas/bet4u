package com.bmp.bet4u.inglaterra.parser;
...
public class PremierLeague implements ICompeticaoParser {
	
	@Override
	public void execute(ResultadoJornadaEpocaCompeticao jornadaCompeticao)
			throws Geral {
		try {
